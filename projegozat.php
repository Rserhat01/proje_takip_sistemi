...
<div class="container">
	<div class="card">
		<div class="card-header">
			<h3 class="display-4" style="font-size: 2rem;">Projelere Gözat</h3>
		</div>
		<div class="card-body">
			<form action="projeler.php" method="POST">
				<div class="form-row">
					<div class="col-md-6">
						...
						<input disabled type="text" name="proje_baslik" class="form-control" value="<?php echo $projecek['proje_baslik'] ?>">
					</div>
					<div class="col-md-6">
						<label>Teslim Tarihi</label>
						<input disabled type="date" name="proje_teslim_tarihi" class="form-control" value="<?php echo $projecek['proje_teslim_tarihi'] ?>">
					</div>
				</div>
				<div class="form-row mt-2">
					<div class="col-md-6">
						<label>Proje Aciliyeti</label>
						<select disabled name="proje_aciliyet" class="form-control">
					...
					<div class="col-md-6">
						...
						<select disabled name="proje_durum" class="form-control">
				...
				<input disabled type="hidden" name="proje_id" value="<?php echo $_POST['proje_id']; ?>">
				<div class="form-row mt-3">
					<div class="col-md-12">
						<label>Proje Detayı</label>
						<textarea disabled name="proje_detay" class="form-control mt-1"><?php echo $projecek['proje_detay'] ?></textarea>
					</div>
				</div>
				<button type="submit" name="projeduzenle" class="btn btn-primary mt-2">Geri Dön</button>
			</form>
		</div>
	</div>
</div>
